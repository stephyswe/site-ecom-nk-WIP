export const SectionMembership = () => (
  <div>
    <section className="p q a0 aj ak i9 be h9 gx am">
      <div className="jm jj">
        <div className="p q r s e">
          <div className="dp h0 h1 jn h3">
            ...
            >
              <img
                src="/globalassets/sb-2022/jacobs-updates/namnlost-3.jpg?ref=2BA3662262&w=1920&format=jpg&quality=85"
                srcSet="/globalassets/sb-2022/jacobs-updates/namnlost-3.jpg?ref=2BA3662262&w=2880&format=jpg&quality=85 1.5x"
                alt="NK Nyckeln"
                width={1440}
                height={720}
                id="HeroBlockV2"
          ...
          <div className="d8 d9">
            ...
            <div className="ex jl">
              <p className="fi gw">
                ...
                >
                  <span className="NormalTextRun SCXO226075400 BCX8">
                    del av en unik shoppingupplevelse och blir på riktigt en del
                    av NK:s värld. Medlemskapet kostar dig ingenting, men ger
                    ett stort mervärde.
                  </span>
                </span>
              </p>
